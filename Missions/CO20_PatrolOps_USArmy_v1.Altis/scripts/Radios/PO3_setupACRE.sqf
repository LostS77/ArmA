...
if(PO3CLI) then {
	[] spawn {
		...
		[[getPosASL acreTower_1 select 0, getPosASL acreTower_1 select 1, (getPosASL acreTower_1 select 2) + 2500], 36.625, 342.675, 20000];
		[[getPosASL acreTower_2 select 0, getPosASL acreTower_2 select 1, (getPosASL acreTower_2 select 2) + 2500], 36.625, 342.675, 20000];
		[[getPosASL acreTower_3 select 0, getPosASL acreTower_3 select 1, (getPosASL acreTower_3 select 2) + 2500], 36.625, 342.675, 20000];
		[[getPosASL acreTower_4 select 0, getPosASL acreTower_4 select 1, (getPosASL acreTower_4 select 2) + 2500], 36.625, 342.675, 20000];
		[[getPosASL acreTower_5 select 0, getPosASL acreTower_5 select 1, (getPosASL acreTower_5 select 2) + 2500], 36.625, 342.675, 20000];
	};
};
